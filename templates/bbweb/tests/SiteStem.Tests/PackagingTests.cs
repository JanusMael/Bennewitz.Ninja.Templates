...
/// <summary>
/// Guards what this repository publishes. A site releases binaries and a container image, and packs
...
{
    [Fact]
    public void The_site_is_never_packed()
    {
        XDocument site = XDocument.Load(Path.Combine(RepoRoot(), "src", "SiteStem", "SiteStem.csproj"));

        Assert.Contains(
            site.Descendants("IsPackable"),

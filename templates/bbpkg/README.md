...
<!-- bbpkg: one paragraph saying what this package does, in the words someone searching nuget.org would use. This file is packed into the package, so it is also the description shown on nuget.org -->
## Install
